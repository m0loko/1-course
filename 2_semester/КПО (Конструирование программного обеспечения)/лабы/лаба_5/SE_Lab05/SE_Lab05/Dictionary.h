...
#define THROW08 "UpdEntry: дублирование идефинтификатора"
namespace Dictionary {
	...
	void UpdEntry(Instance& inst, int id, Entry new_ed); //изменить элемент словар€ (экземпл€р словар€ и идефикатор удал€емого элемента)
